...
const ekranaYazdir = (resim) => {
    ...
    <div class="yükseklik col-12 col-md-6 col-lg-4 mb-4">
        <div class="card boyut">
            ...
            <div class="card-body">
            <h5 class="card-title text-secondary fw-bold fs-5">${resim.title}</h5>
...
// !Ürünler içerisinde isime görre filtreleme yapmak için;
...
// !Sepete ekle butonuna bastığımızda değeri arttıracak kodlar
...
const sepeteEkle = (parentDiv) => {
    ...
    // !Sepet içerisindeki arttır ve azalt butonların kodları
...
// !Sepetteki Çarpı butonuna basınca elemanı sildirme
